...
- **Class UDF state:** Constructor callables and custom objects recompute by default. Override [`identity_hash()`](python-engine.md#cache-identity) only when you can provide a complete stable identity.
